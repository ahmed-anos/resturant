      ...
      <div class="m-4 max-w-md mt-5 mb-11 p-4 text-center mx-auto">
       <h3 class="font-bold font-cursive-merie text-4xl leading-normal capitalize">
          <?php if(App::getLocale() == 'ar'): ?>
              <?php echo e(__('home.dishes')); ?> <span class="text-amber-400 leading-snug"><?php echo e(__('home.fav')); ?></span>
          <?php else: ?>
              <?php echo e(__('home.our')); ?> <span class="text-amber-400 leading-snug"><?php echo e(__('home.fav')); ?></span> <?php echo e(__('home.dishes')); ?>

          <?php endif; ?>
      </h3>

        <p class="pt-2 text-[14px] font-sans-lato text-slate-600 leading-relaxed"><?php echo e(__('home.dishes_desc')); ?></p>
      </div>
    ...
    <!-- Deshes Area End --><?php /**PATH C:\laragon\www\RESTURANT\restaurant-site-laravel-master\resources\views/home/partials/deshes.blade.php ENDPATH**/ ?>
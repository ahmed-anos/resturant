<x-admin.index :user="$user" :isAdmin="$isAdmin">
	<div class="content-wrapper food_btn_add">
		<a href="{{ route('foodmenu.create') }}" class=" btn btn-primary mx-2">{{ __('admin.add_food') }}
		...
		<div class="col-lg-12 grid-margin stretch-card">
			<div class="card">
				<div class="card-body food_body">
					<h4 class="card-title">{{ __('admin.food_table') }}</h4>					
					<p class="card-description">
						{{ __('admin.food_table_desc') }}
					</p>
					...
					<table class="table table-hover overflow-auto block">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a style="padding: 8px 12px" href="{{ route('foodmenu.edit', $data->id) }}" class="badge badge-primary cursor-pointer">
								...
								<td>
									...
									<form id="delete-form-{{ $data->id }}" action="{{ route('foodmenu.destroy', $data->id) }}" method="POST" style="display: none;">
									@csrf
									@method('DELETE')
								</form>
